...
type AuthorServiceClient interface {
	GetAllAuthors(ctx context.Context, in *books.Empty, opts ...grpc.CallOption) (*AuthorList, error)
...
func (c *authorServiceClient) GetAllAuthors(ctx context.Context, in *books.Empty, opts ...grpc.CallOption) (*AuthorList, error) {
	out := new(AuthorList)
...
type AuthorServiceServer interface {
	GetAllAuthors(context.Context, *books.Empty) (*AuthorList, error)
...
func (UnimplementedAuthorServiceServer) GetAllAuthors(context.Context, *books.Empty) (*AuthorList, error) {
...
func _AuthorService_GetAllAuthors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorServiceServer).GetAllAuthors(ctx, req.(*books.Empty))
	}
